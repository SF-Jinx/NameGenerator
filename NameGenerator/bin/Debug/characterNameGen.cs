...
namespace NameGenerator
{
    public partial class characterNameGen : Form
    {
        ...
        string mainDirectoryPath = "mainDirectoryPath.txt";
        ...
        private void generateFilenameButton_Click(object sender, EventArgs e)
        {
            ...
            if (System.IO.File.Exists(mainDirectoryPath))
            {
                targetPath = System.IO.File.ReadAllText(mainDirectoryPath);
            }
...
//            System.IO.File.Copy(sourceFile, fullPathName);
        ...
        private string selectFile()
        {
            ...
            if (fileDlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                fileAddedCheckbox.Checked = true;
                return file;
            }
            else { return null; }
        }
        ...
        private string selectFolder()
        {
            ...
            folderDlg.Description = "Select main file upload directory (Opifex 2014 Assets)";
            ...
            if (folderDlg.ShowDialog() == System.Windows.Forms.DialogResult.OK)
            {
                ...
                System.IO.File.WriteAllText(@mainDirectoryPath, folderDlg.SelectedPath);
                MessageBox.Show(System.IO.Path.GetFullPath(mainDirectoryPath));
